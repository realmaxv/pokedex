...
// //   types,
// //   cries,
// }: SinglePokemonCardProbs) {
// // useEffect, useState pokemon muss noch entstehen (fetch)
...
//           <button key={index} className="type-badge">
//             {singleType.type.name}
//           </button>
//         ))}
//       <audio src={cries} controls autoPlay />
//     </div>
//   );
// }
